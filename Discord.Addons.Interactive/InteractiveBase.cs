namespace Discord.Addons.Interactive
{
        ...
        where T : SocketCommandContext
    {
        ...
        public Task<IUserMessage> ErrorAsync(string content, TimeSpan? timeout = null, RequestOptions options = null)
            => Interactive.ErrorAsync(Context, content, false, timeout, options);
        public Task<IUserMessage> OkAsync(string content, TimeSpan? timeout = null, RequestOptions options = null)
            => Interactive.OkAsync(Context, content, false, timeout, options);
