namespace Discord.Addons.Interactive
{
    ...
    public class PaginatedMessage
    {
        ...
        public class Page
        {
            ...
            public void AddField(string title, object value, bool inline = false)
            {
                Fields.Add(new EmbedFieldBuilder { Name = title, Value = value, IsInline = inline });
            }
        }
    }
}
